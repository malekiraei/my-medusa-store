      ...
      <Container className="overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base p-0 shadow-elevation-card-rest">
        ...
        <div className="p-3.5">
          ...
          <div
            ...
            className="relative h-36 select-none overflow-hidden rounded-lg border border-ui-border-base bg-ui-bg-subtle/15 px-3 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.55)] outline-none focus:outline-none focus-visible:outline-none [&_*:focus-visible]:outline-none [&_*:focus]:outline-none [&_*]:outline-none [&_g]:outline-none [&_path]:outline-none [&_svg]:select-none [&_svg]:outline-none [&_.recharts-active-dot]:outline-none [&_.recharts-active-shape]:outline-none [&_.recharts-layer]:outline-none [&_.recharts-surface]:outline-none [&_.recharts-tooltip-cursor]:hidden [&_.recharts-wrapper]:outline-none"
          >
            <div aria-hidden="true" className="pointer-events-none absolute inset-x-6 bottom-10 top-5 rounded-md">
