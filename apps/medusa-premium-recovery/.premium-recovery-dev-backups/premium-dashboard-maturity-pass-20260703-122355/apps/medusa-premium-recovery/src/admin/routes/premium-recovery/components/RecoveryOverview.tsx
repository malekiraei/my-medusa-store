          ...
          {signals.map((signal) => {
            ...
            return (
              <div
                key={signal.name}
                className={clsx(
                  "group flex min-h-[78px] min-w-0 flex-col justify-between gap-3 rounded-lg border bg-ui-bg-component px-3.5 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.45)] transition duration-150 hover:border-ui-border-strong hover:bg-ui-bg-component-hover",
                  toneClass.surface
                )}
              >
