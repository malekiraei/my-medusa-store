...
export const PRMetricCard = ({
  ...
  return (
    <article
      className={clsx(
        "group relative flex h-full min-h-[188px] flex-col overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base p-4 shadow-elevation-card-rest transition duration-200 hover:-translate-y-0.5 hover:border-ui-border-strong hover:bg-ui-bg-base-hover hover:shadow-elevation-card-hover",
      ...
      <div className="relative flex h-full flex-col text-start">
        <header className="flex min-w-0 items-start justify-between gap-3">
          <div className="flex min-w-0 items-center gap-3">
            <div
              className={clsx(
                "flex aspect-square size-11 shrink-0 items-center justify-center rounded-xl shadow-lg ring-1 ring-white/20 transition duration-200 group-hover:scale-[1.03]",
        ...
        <div className="mt-5 min-w-0">
          <div className="whitespace-normal break-words text-[1.55rem] font-semibold leading-tight tracking-tight text-ui-fg-base sm:text-[1.7rem]">
            {value}
          </div>
          {description ? (
