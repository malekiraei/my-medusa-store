          ...
          {signals.map((signal, index) => {
            ...
            return (
              <div
                key={signal.name}
                className={clsx(
                  "flex min-h-[35px] flex-1 items-center gap-2 bg-ui-bg-base px-4 py-2 transition duration-150 hover:bg-ui-bg-subtle/55",
                  index === 0 ? "min-h-[46px]" : ""
                )}
              >
                ...
                <Text
                  ...
                  leading="compact"
                  className={clsx(
                    "max-w-[58%] shrink-0 text-end text-xs leading-4",
