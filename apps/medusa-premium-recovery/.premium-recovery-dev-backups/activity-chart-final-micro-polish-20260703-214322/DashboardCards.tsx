...
const SnapshotActivityTooltip = ({
  ...
  return (
    <div className="min-w-[148px] rounded-lg border border-ui-border-base bg-ui-bg-base/95 px-3 py-2 text-start shadow-elevation-card-hover backdrop-blur-sm">
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Line
                  ...
                  dot={{ r: 2.6, strokeWidth: 1.4, fill: "currentColor", opacity: 0.68 }}
                  activeDot={{
                    r: 5,
                    stroke: "var(--bg-base)",
                    strokeWidth: 2.4,
