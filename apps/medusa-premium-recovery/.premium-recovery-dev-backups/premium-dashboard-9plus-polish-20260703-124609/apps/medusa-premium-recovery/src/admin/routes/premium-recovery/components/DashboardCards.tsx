      ...
      <Container className="overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base p-0 shadow-elevation-card-rest">
        ...
        <div className="p-4">
          ...
          <div
            ...
            className="relative h-40 select-none overflow-hidden rounded-lg border border-ui-border-base bg-ui-bg-subtle/20 px-3 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.55)] outline-none focus:outline-none focus-visible:outline-none [&_*:focus-visible]:outline-none [&_*:focus]:outline-none [&_*]:outline-none [&_g]:outline-none [&_path]:outline-none [&_svg]:select-none [&_svg]:outline-none [&_.recharts-active-dot]:outline-none [&_.recharts-active-shape]:outline-none [&_.recharts-layer]:outline-none [&_.recharts-surface]:outline-none [&_.recharts-tooltip-cursor]:hidden [&_.recharts-wrapper]:outline-none"
          >
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Line
                  ...
                  strokeWidth={1.8}
                  strokeOpacity={0.72}
                  dot={{ r: 2.5, strokeWidth: 1.2, fill: "currentColor", opacity: 0.72 }}
                  activeDot={{ r: 4, strokeWidth: 0, opacity: 0.85 }}
                  isAnimationActive={false}
                  className="text-ui-fg-muted"
                />
              </AreaChart>
