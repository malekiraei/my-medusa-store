...
export const PRMetricCard = ({
  ...
  return (
    <article
      className={clsx(
        "group relative flex h-full min-h-[176px] flex-col overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base p-4 shadow-elevation-card-rest transition duration-200 hover:-translate-y-0.5 hover:border-ui-border-strong hover:bg-ui-bg-base-hover hover:shadow-elevation-card-hover",
    ...
    >
      ...
      <div className="relative flex h-full flex-col text-start">
        ...
        <div className="mt-4 min-w-0">
          <div className="whitespace-normal break-words text-[1.42rem] font-semibold leading-[1.16] tracking-tight text-ui-fg-base sm:text-[1.54rem]">
            {value}
          </div>
          {description ? (
            <Text className="mt-2 text-sm leading-5 text-ui-fg-subtle">
              {description}
            </Text>
          ) : null}
        </div>
