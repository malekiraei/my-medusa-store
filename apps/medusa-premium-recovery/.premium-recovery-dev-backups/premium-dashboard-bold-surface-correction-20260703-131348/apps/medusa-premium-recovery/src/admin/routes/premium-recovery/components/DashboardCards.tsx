...
export const DashboardCards = ({
  ...
  return (
    <div className={clsx("space-y-3", className)}>
      ...
      <Container className="overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base p-3.5 shadow-elevation-card-rest">
          <div
            aria-label="Activity preview chart for the last 30 days"
            tabIndex={-1}
            onMouseDown={(event) => event.preventDefault()}
            className="relative h-40 select-none overflow-hidden rounded-lg bg-ui-bg-subtle/10 px-4 pb-3 pt-3.5 outline-none focus:outline-none focus-visible:outline-none [&_*:focus-visible]:outline-none [&_*:focus]:outline-none [&_*]:outline-none [&_g]:outline-none [&_path]:outline-none [&_svg]:select-none [&_svg]:outline-none [&_.recharts-active-dot]:outline-none [&_.recharts-active-shape]:outline-none [&_.recharts-layer]:outline-none [&_.recharts-surface]:outline-none [&_.recharts-tooltip-cursor]:hidden [&_.recharts-wrapper]:outline-none"
          >
            ...
            <div aria-hidden="true" className="pointer-events-none absolute inset-x-7 bottom-10 top-20 rounded-md">
            ...
            <div className="absolute inset-x-4 bottom-3 top-[4.75rem]">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Line
                  ...
                  strokeWidth={1.7}
                  strokeOpacity={0.68}
                  dot={{ r: 2.25, strokeWidth: 1, fill: "currentColor", opacity: 0.68 }}
