  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-col text-start">
        <header className="min-h-[3.75rem] min-w-0 ps-14">
          <div className="min-w-0 pt-0.5">
            <Text className="whitespace-normal text-[11px] font-semibold uppercase leading-4 tracking-[0.1em] text-ui-fg-muted">
              {title}
            </Text>
            {badge ? (
