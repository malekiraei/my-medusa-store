...
const snapshotActivityPreviewData = [
  { day: "Day 1", snapshots: 0 },
  { day: "Day 5", snapshots: 1 },
  { day: "Day 9", snapshots: 1 },
  { day: "Day 13", snapshots: 2 },
  { day: "Day 17", snapshots: 1 },
  { day: "Day 21", snapshots: 3 },
  { day: "Day 25", snapshots: 2 },
  { day: "Day 30", snapshots: 4 },
]
  ...
  return (
    <div className={clsx("space-y-4", className)}>
      ...
      <Container className="overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base p-0 shadow-elevation-card-rest">
        <div className="grid gap-4 p-4 lg:grid-cols-[minmax(180px,0.45fr)_minmax(0,1fr)] lg:items-center">
          ...
          <div
            aria-label="Snapshot activity preview chart for the last 30 days"
            className="relative h-28 overflow-hidden rounded-lg border border-ui-border-base bg-ui-bg-subtle/45 px-3 py-3"
          >
