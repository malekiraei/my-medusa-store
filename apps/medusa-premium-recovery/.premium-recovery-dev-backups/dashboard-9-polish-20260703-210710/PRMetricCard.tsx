...
export const PRMetricCard = ({
  ...
  return (
    <article
      className={clsx(
        "group relative flex h-full min-h-[164px] flex-col overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base p-3.5 shadow-elevation-card-rest transition duration-200 hover:-translate-y-0.5 hover:border-ui-border-strong hover:bg-ui-bg-base-hover hover:shadow-elevation-card-hover",
      ...
      <div className="relative flex h-full flex-col text-start">
        <header className="flex min-w-0 items-start justify-between gap-3">
          <div className="flex min-w-0 items-center gap-2.5">
            <div
              className={clsx(
                "flex aspect-square size-10 shrink-0 items-center justify-center rounded-lg shadow-lg ring-1 ring-white/20 transition duration-200 group-hover:scale-[1.03]",
            ...
            <div className="min-w-0">
              <Text className="whitespace-normal break-words text-[11px] font-semibold uppercase leading-4 tracking-[0.1em] text-ui-fg-muted">
                {title}
              </Text>
            </div>
          </div>
        ...
        <div className="mt-3.5 min-w-0">
          <div className="whitespace-normal break-words text-[1.38rem] font-semibold leading-[1.16] tracking-tight text-ui-fg-base sm:text-[1.48rem]">
            {value}
          </div>
          {description ? (
            <Text className="mt-1.5 text-sm leading-5 text-ui-fg-subtle">
              {description}
            </Text>
          ) : null}
        </div>
