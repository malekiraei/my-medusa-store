...
export const PRMetricCard = ({
  ...
  return (
    <article
      className={clsx(
        "group relative flex h-full min-h-[184px] flex-col overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base px-4 pb-5 pt-4 shadow-elevation-card-rest transition duration-200 hover:-translate-y-0.5 hover:border-ui-border-strong hover:bg-ui-bg-base-hover hover:shadow-elevation-card-hover",
    ...
    >
      ...
      <div className="relative flex h-full flex-col text-start">
        <header className="min-h-[4.25rem] min-w-0 ps-14">
