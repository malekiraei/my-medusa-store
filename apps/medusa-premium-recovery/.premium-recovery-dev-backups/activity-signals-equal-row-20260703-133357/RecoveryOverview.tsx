...
export const RecoveryOverview = ({
  ...
  return (
    <Container className="w-full overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base p-0 shadow-elevation-card-rest">
      <div className="grid gap-0 divide-y divide-ui-border-base xl:grid-cols-[minmax(132px,0.18fr)_minmax(0,1fr)] xl:divide-x xl:divide-y-0">
        <div className="flex min-w-0 flex-col justify-center px-4 py-3 text-start">
        ...
        <div className="grid min-w-0 divide-y divide-ui-border-base sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-5">
          {signals.map((signal, index) => {
            ...
            return (
              <div
                key={signal.name}
                className={clsx(
                  "group flex min-h-[72px] min-w-0 flex-col justify-between gap-2 bg-ui-bg-base px-3.5 py-3 transition duration-150 hover:bg-ui-bg-subtle/55",
