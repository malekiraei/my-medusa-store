...
export const PRMetricCard = ({
  ...
  return (
    <article
      className={clsx(
        "group relative flex h-full min-h-[212px] flex-col overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base px-4 pb-5 pt-4 shadow-elevation-card-rest transition duration-200 hover:-translate-y-0.5 hover:border-ui-border-strong hover:bg-ui-bg-base-hover hover:shadow-elevation-card-hover",
    ...
    >
      ...
      <div className="relative flex h-full flex-col text-start">
        <header className="min-h-[4.5rem] min-w-0 ps-14">
        ...
        <div className="mt-1 min-w-0">
          <div className="whitespace-normal break-words text-[1.6rem] font-semibold leading-tight tracking-tight text-ui-fg-base sm:text-[1.8rem]">
            {value}
          </div>
          {description ? (
