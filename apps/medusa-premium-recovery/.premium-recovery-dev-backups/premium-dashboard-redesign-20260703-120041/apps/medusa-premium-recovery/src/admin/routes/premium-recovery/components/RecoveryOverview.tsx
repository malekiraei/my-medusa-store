...
export const RecoveryOverview = ({
  ...
  return (
    <Container className="w-full overflow-hidden rounded-lg border border-ui-border-base bg-ui-bg-base p-0 shadow-elevation-card-rest">
      <div className="grid gap-3 p-3 xl:grid-cols-[minmax(150px,0.22fr)_minmax(0,1fr)] xl:items-stretch">
        <div className="flex min-w-0 items-center justify-between gap-3 text-start">
          ...
          {signals.map((signal) => {
            ...
            return (
              <div
                key={signal.name}
                className={clsx(
                  "flex min-h-[58px] min-w-0 items-start gap-2 rounded-md border bg-ui-bg-component px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.45)]",
                  toneClass.surface
                )}
              >
                <div className="flex min-w-0 flex-1 items-start gap-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <Text
                      ...
                      leading="compact"
                      className={clsx(
                        "mt-0.5 whitespace-normal break-words text-xs leading-4",
