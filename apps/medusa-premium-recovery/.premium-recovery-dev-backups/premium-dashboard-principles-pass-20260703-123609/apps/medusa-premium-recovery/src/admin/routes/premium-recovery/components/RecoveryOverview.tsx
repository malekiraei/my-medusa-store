...
export const RecoveryOverview = ({
  ...
  return (
    <Container className="w-full overflow-hidden rounded-xl border border-ui-border-base bg-ui-bg-base p-0 shadow-elevation-card-rest">
      <div className="border-b border-ui-border-base px-5 py-3.5">
        <div className="flex min-w-0 items-start justify-between gap-3 text-start">
      ...
      <div className="p-4">
        ...
        <div className="grid min-w-0 gap-2.5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
          {signals.map((signal, index) => {
            ...
            return (
              <div
                key={signal.name}
                className={clsx(
                  "group flex min-h-[68px] min-w-0 flex-col justify-between gap-2.5 rounded-lg border bg-ui-bg-component px-3.5 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.45)] transition duration-150 hover:border-ui-border-strong hover:bg-ui-bg-component-hover",
                ...
                <div className="flex min-w-0 items-start justify-between gap-3">
                  <div className="flex min-w-0 items-start gap-2.5">
                    ...
                    <Text
                      ...
                      leading="compact"
                      weight="plus"
                      className="whitespace-normal break-words text-ui-fg-base"
                    >
                      {signal.name}
                    </Text>
                  </div>
